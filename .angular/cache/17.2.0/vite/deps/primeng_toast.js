...
function ToastItem_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r1.headlessTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c1, ctx_r1.message, ctx_r1.onCloseIconClick));
  }
}
function ToastItem_ng_template_3_ng_container_1_span_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMap("p-toast-message-icon pi " + ctx_r8.message.icon);
  }
}
...
function ToastItem_ng_template_3_ng_container_1_span_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("aria-hidden", true)("data-pc-section", "icon");
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r9.message.severity === "success");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r9.message.severity === "info");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r9.message.severity === "error");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r9.message.severity === "warn");
  }
}
function ToastItem_ng_template_3_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r5.message.icon);
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r5.message.icon);
    ɵɵadvance();
    ...
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r5.message.summary);
    ɵɵadvance();
    ɵɵattribute("data-pc-section", "detail");
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r5.message.detail);
  }
}
...
function ToastItem_ng_template_3_button_3_span_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMap("pt-1 text-base p-toast-message-icon pi " + ctx_r14.message.closeIcon);
  }
}
...
function ToastItem_ng_template_3_button_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function ToastItem_ng_template_3_button_3_Template_button_click_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r16.onCloseIconClick($event));
      ...
      return ɵɵresetView(ctx_r18.onCloseIconClick($event));
    });
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("aria-label", ctx_r7.closeAriaLabel)("data-pc-section", "closebutton");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r7.message.closeIcon);
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r7.message.closeIcon);
  }
}
...
function ToastItem_ng_template_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ctx_r2.message == null ? null : ctx_r2.message.contentStyleClass);
    ɵɵattribute("data-pc-section", "content");
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r2.template);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r2.template)("ngTemplateOutletContext", ɵɵpureFunction1(6, _c2, ctx_r2.message));
    ɵɵadvance();
    ɵɵproperty("ngIf", (ctx_r2.message == null ? null : ctx_r2.message.closable) !== false);
  }
}
var _c3 = (a0) => [a0, "p-toast-message"];
var _c4 = (a0, a1, a2, a3) => ({
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ToastItem_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(2, ToastItem_ng_container_2_Template, 2, 5, "ng-container", 2)(3, ToastItem_ng_template_3_Template, 4, 8, "ng-template", null, 3, ɵɵtemplateRefExtractor);
        ɵɵelementEnd();
      }
      if (rf & 2) {
        const _r3 = ɵɵreference(4);
        ɵɵclassMap(ctx.message == null ? null : ctx.message.styleClass);
        ɵɵproperty("ngClass", ɵɵpureFunction1(9, _c3, "p-toast-message-" + (ctx.message == null ? null : ctx.message.severity)))("@messageState", ɵɵpureFunction1(16, _c5, ɵɵpureFunction4(11, _c4, ctx.showTransformOptions, ctx.hideTransformOptions, ctx.showTransitionOptions, ctx.hideTransitionOptions)));
        ɵɵattribute("id", ctx.message == null ? null : ctx.message.id)("data-pc-name", "toast")("data-pc-section", "root");
        ɵɵadvance(2);
        ɵɵproperty("ngIf", ctx.headlessTemplate)("ngIfElse", _r3);
      }
    },
