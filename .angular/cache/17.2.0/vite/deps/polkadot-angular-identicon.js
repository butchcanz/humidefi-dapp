...
// node_modules/@polkadot/ui-shared/node_modules/color/index.js
var require_color = __commonJS({
  "node_modules/@polkadot/ui-shared/node_modules/color/index.js"(exports, module) {
    "use strict";
...
function colors(seeder2) {
  ...
  const all = COLORS.map((hex) => (0, import_color.default)(hex).rotate(amount));
  return (alpha = 1) => {
...
var blake2 = (value) => blake2AsU8a(value, 512);
var S = 64;
var C = S / 2;
var Z = S / 64 * 5;
...
function findScheme(d) {
  let cum = 0;
  const schema = Object.values(SCHEMA).find((schema2) => {
    cum += schema2.freq;
    return d < cum;
  });
  if (!schema) {
...
function polkadotIcon(address, {
  ...
  const colors2 = getColors(address);
...
// node_modules/polkadot-angular-identicon/fesm2015/polkadot-angular-identicon.js
var DEFAULT_SIZE = 64;
var THEMES_ENUM;
(function(THEMES_ENUM2) {
  THEMES_ENUM2["POLKADOT"] = "polkadot";
  THEMES_ENUM2["BEACHBALL"] = "beachball";
  THEMES_ENUM2["JDENTICON"] = "jdenticon";
  THEMES_ENUM2["EMPTY"] = "empty";
...
var RenderHelper = class {
  ...
  static renderCircle({
    ...
    let svg2 = `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
...
var PolkadotIdentIconComponent = class {
...
PolkadotIdentIconComponent.ɵfac = function PolkadotIdentIconComponent_Factory(t) {
  return new (t || PolkadotIdentIconComponent)(ɵɵdirectiveInject(DomSanitizer));
};
PolkadotIdentIconComponent.ɵcmp = ɵɵdefineComponent({
  type: PolkadotIdentIconComponent,
  selectors: [["polkadot-angular-identicon"]],
  inputs: {
    address: "address",
    size: "size",
    theme: "theme"
  ...
  decls: 1,
  vars: 2,
  consts: [[3, "innerHTML", "ngStyle"]],
  template: function PolkadotIdentIconComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelement(0, "div", 0);
    }
    if (rf & 2) {
      ɵɵproperty("innerHTML", ctx.iconHTML, ɵɵsanitizeHtml)("ngStyle", ctx.getStyle());
    }
  },
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PolkadotIdentIconComponent, [{
    type: Component,
    args: [{
...
var PolkadotIdentIconModule = class {
};
PolkadotIdentIconModule.ɵfac = function PolkadotIdentIconModule_Factory(t) {
  return new (t || PolkadotIdentIconModule)();
};
PolkadotIdentIconModule.ɵmod = ɵɵdefineNgModule({
  type: PolkadotIdentIconModule,
  declarations: [PolkadotIdentIconComponent],
  imports: [CommonModule, BrowserModule],
  exports: [PolkadotIdentIconComponent]
});
PolkadotIdentIconModule.ɵinj = ɵɵdefineInjector({
  imports: [[CommonModule, BrowserModule]]
});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PolkadotIdentIconModule, [{
    type: NgModule,
    args: [{
      declarations: [PolkadotIdentIconComponent],
      imports: [CommonModule, BrowserModule],
